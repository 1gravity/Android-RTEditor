...
public class UrlValidator implements Serializable {
    ...
    public boolean isValid(String value) {
        ...
        if ("mailto".equals(scheme)) {
            // Special case - mailto: allows an empty/null authority and email validation for the path 
        	String path = urlMatcher.group(PARSE_URL_PATH);
        	return EmailValidator.getInstance().isValid(path);
        }
        else {
            ...
            else if (!isValidAuthority(authority)) {	// Validate the authority
            	return false;
            }
