...
public class ElementType {
	 ...
	 * @param model
	 *            ORed-together bits representing the content models allowed in
	 *            the content of this element type
	 * @param memberOf
	 *            ORed-together bits representing the content models to which
	 *            this element type belongs
	 * @param flags
	 *            ORed-together bits representing the flags associated with this
	 *            element type
	 * @param schema
	 ...
	 * 
	 * @param flags
	 *            associated with this element type The flags as a vector of
	 *            bits
	 */
