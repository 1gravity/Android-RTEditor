...
public class RTEditText extends EditText implements TextWatcher, SpanWatcher, LinkSpanListener {
	 ...
	 * 
	 * @param isRichText
	 *            True if the edit mode should be rich text, False if the edit
	 *            mode should be plain text
	 * @param autoConvert
	 *            Automatically convert the content to plain or rich text if
	 *            this is True
	 */
	 ...
	 * 
	 * @param format
	 *            The RTFormat the text should be converted to.
	 * 
	 * @throws UnsupportedOperationException
	 *             if the target format isn't supported.
	 */
