...
public class FontManager {
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                synchronized(ASSET_FONTS_BY_NAME) {
                    getAssetFonts(context.getResources());
                }
     ...
     */
    public static SortedSet<RTTypeface> getFonts(Resources res) {
        /*
         * Fonts from the assets folder
         */
        Map<String, String> assetFonts =  getAssetFonts(res);
     ...
     *         If the name can't be retrieved the file name will be used (e.g. arial.ttf).
     */
    private static Map<String, String> getAssetFonts(Resources res) {
        synchronized(ASSET_FONTS_BY_NAME) {
            /*
            ...
            if (ASSET_FONTS_BY_NAME.isEmpty()) {
                AssetManager assets = res.getAssets();
                Collection<String> fontFiles = listFontFiles(res);
