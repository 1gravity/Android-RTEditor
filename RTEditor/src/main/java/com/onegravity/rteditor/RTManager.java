...
public class RTManager implements RTToolbarListener, RTEditTextListener {
	 ...
	 *            If the component is being re-initialized after previously
	 ...
	 * 
	 * @param isSaved
	 *            True if the text is saved, False if it's dismissed. This is
	 ...
	 * 
	 * @param editor
	 *            The rich text editor to register.
	 */
	 ...
	 * 
	 * @param editor
	 *            The rich text editor to unregister.
	 */
