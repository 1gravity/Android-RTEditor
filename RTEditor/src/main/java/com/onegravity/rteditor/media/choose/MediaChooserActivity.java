...
import com.onegravity.rteditor.media.choose.GifChooserManager.GifChooserListener;
...
public class MediaChooserActivity extends MonitoredActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (extras != null) {
            ...
            mMediaFactory = (RTMediaFactory<RTImage, RTGif, RTAudio, RTVideo>) extras.getSerializable(EXTRA_MEDIA_FACTORY);
        }
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (resultCode == Activity.RESULT_OK) {
            ...
            } else if (requestCode == MediaAction.PICK_GIF.requestCode()) {
                mMediaChooserMgr.processMedia(MediaAction.PICK_GIF, data);
    ...
    @Override
    public void onGifChosen(final RTGif gif) {
        EventBus.getDefault().postSticky(new MediaEvent(gif));
        finish();
    }
